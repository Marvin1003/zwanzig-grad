...
import style from '../frontend/styles/pages/impressum';

export default () => (
  <App title="Impressum" className='layout_wrapper'>
    <div className="wrapper">
      <style jsx>{style}</style>
      <address className="info didonesque_normal">
        <span>Angaben gemäß §5 TMG</span>
        <span>zwanzig-grad</span>
        <div>
          <span>Stephan-Schulke-Wegner</span>
          <span>Wertherstraße 310</span>
          <span>33619 Bielefeld</span>
        </div>
        <div>
          <span>info@zwanzig-grad.de</span>
          <span>www.zwanzig-grad.de</span>
          <span>0171 - 666888</span>
        </div>

        <span>Umsatz - Steuer ID:</span>
      </address>
      <div className="rechtliches futura_normal">
        <div>
