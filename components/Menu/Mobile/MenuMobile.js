...
export default class extends React.Component {
  menuItems = this.props.menuItems.map(elem => (
    <li
      key={elem}
      className="mobile_menu_headline quattrocento_normal"
  ...
  constructor(props) {
    ...
    this.tl = new TimelineLite({
      onReverseComplete: () => this.props.toggleMenu("button")
    });
  }
  ...
  componentDidMount() {
    this.tl
      ...
      .staggerFromTo(
        ...
        0.75,
        { alpha: 0, y: 100 },
        { alpha: 1, y: 0, ease: Power4.easeOut },
        0.075,
        0.5
      )
      .staggerFromTo(
  ...
  toggleAnimation = prevProps => {
    if (prevProps.reverse !== this.props.reverse) {
      this.props.reverse ? this.tl.reverse() : this.tl.play();
    }
  };
          ...
          <div className="wrapper">
            ...
            <div className="info_container">
              ...
              <div className="kontakt info_menu stagger_item">
                ...
                <span>
                  <a href="tel:+49 171 64 30 96 2">+49 171 64 30 96 2</a>
                </span>
                <span>
                  <a href="tel:+49 521 52 14 00 2">+49 521 52 14 00 2</a>
                </span>
                <span>
                  <a href="mailto:info@zwanzig-grad.de">info@zwanzig-grad.de</a>
                </span>
              </div>
            </div>
          </div>
          <a
            onClick={() => this.props.routeHandling("impressum")}
            className="corner_buttons font_medium impressum stagger_item"
          >
            Impressum
          </a>
        </nav>
